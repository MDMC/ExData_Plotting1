...
tidyData <- dateData
#
# Line Plot Global Active Power as a function of time
# and save to plot2.png
par(mar=c(5, 6, 4, 2))
plot(tidyData$DateTime, tidyData$ActivePower, ylab="Global Active Power (kilowatts)", xlab="", type="l")
