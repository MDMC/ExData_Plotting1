...
tidyData <- dateData
#
# Line Plot Energy Submetering as a function of time
...
legend("topright", col=c("black", "red", "blue"), legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"),cex=.6, pt.cex=1, lty=c(1,1,1), lwd=c(2.5, 2.5, 2.5))
